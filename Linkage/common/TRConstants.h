...
// 抽象方法定义
#define MustOverride() @throw [NSException exceptionWithName:NSInvalidArgumentException reason:[NSString stringWithFormat:@"%s must be override in a subclass/category", __PRETTY_FUNCTION__] userInfo:nil]
